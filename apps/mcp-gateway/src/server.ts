...
export const SERVER_INSTRUCTIONS =
  ...
  "never try to approve your own. The one exception, off unless the owner turns it on: on a " +
  "'peer' canvas a REVIEWER agent uses task_review on a DIFFERENT agent's work — 'pass' approves " +
  "a proposed task, 'changes_requested' sends finished work back with a reason. Read it first; " +
  "epics and rejection stay human-only. " +
