    ...
    <section className="relative overflow-hidden">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-24 lg:grid-cols-[1fr_1.05fr]">
        ...
        <div className="min-w-0">
          ...
          <div className="rounded-xl border border-ink/10 bg-surface p-3.5 shadow-[6px_6px_0_rgba(28,25,23,0.08)]">
          ...
          {/* The other end of the chain: the repo. theme-light keeps the
              terminal dark in both themes (else it inverts to light). */}
          <div className="theme-light overflow-hidden rounded-md border-[1.5px] border-ink bg-ink text-paper shadow-[6px_6px_0_rgba(13,110,102,0.35)]">
            <div className="flex items-center gap-2 border-b border-paper/10 px-4 py-2.5">
              ...
              <span className="h-2 w-2 rounded-full bg-paper/20" />
              <span className="font-code text-[10px] text-paper/45">your repo</span>
            </div>
            <div className="overflow-x-auto px-4 py-3 font-code text-[11.5px] leading-relaxed">
              <div className="whitespace-nowrap text-paper/55">
                <span className="text-agent">$</span> git log --oneline | grep {RECEIPT.ticket}
              </div>
              <div className="mt-1 whitespace-nowrap">
                <span className="text-emerald-400/90">{RECEIPT.commit}</span>{" "}
                <span className="text-paper/80">feat: rate-limit the websocket hub ({RECEIPT.ticket})</span>
              </div>
            </div>
          </div>
